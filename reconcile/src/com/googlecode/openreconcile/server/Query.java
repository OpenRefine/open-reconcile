...
public class Query {
     ...
     * 
     * @param queryterm
     *            the term to be queried for
     * @param newlimit
     *            the limit of number of results that Google Refine wants back
     * @param newtype
     *            the type assigned to the query
     * @param typeStrict
     *            if the type should be obeyed strictly (note: this is ignored)
     * @param newproperties
     *            additional properties sent along with the query (note: this is
     *            ignored)
     */
     ...
     * 
     * @return the string value for the maximum number of items requested in the
     *         results
     */
     ...
     * 
     * @return the string value for the type the term is to be reconciled
     *         against
     */
     ...
     * 
     * @return the string value for if the type is to be strictly enforced or no
