...
public final class ReconcileServlet extends HttpServlet{
     ...
     * response, creating objects and calling functions as necessary
     * 
     * @param request
     *            - HttpServletRequest
     * @param response
    ...
    public void doGet (HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException{
        ...
        if(request.getParameter("queries")!=null){
            ...
            List<Result> resp = runQuery(query);
    ...
    /**
     * Generates the MetaData which is returned for all non-query calls. The
     * MetaData information is kept in a configuration file, which is a sqlite
...
//        }
     ...
     *    
	@return An List of Result objects, which will be returned and parsed into the JSON response
     *  
     */
    ...
    public String runQueries(HttpServletRequest jsonReq){
        ...
        // Put them into an List of Query objects for easier handling
        ...
        for (int i = 0; i<qList.size() && qList.get(i)!=null; i++){
            List<Result> singleQueryResultSet;
    ...
    class Queries{
        ...
        public List<Query> getQueries(){
            List<Query> returnThis = new ArrayList<Query>();
            returnThis.add(q0);
            returnThis.add(q1);
            returnThis.add(q2);
            returnThis.add(q3);
    ...
    public class MetaData{
        ...
        public MetaData(String cname, List<Library> libs){
            name = cname;	
