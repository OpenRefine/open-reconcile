...
//        }
    ...
    /**
     * Populates the Map of Strings that is the substitution table. It's called
     * only at the end of the constructor and is private.
     **/		
...
//        }
    ...
    /**
     * Populates the List of Strings that is the vocabulary. It's called only at
...
//            }	
    ...
    /**
     * Returns the boolean value stored in the configuration file for
     * sensitivity to case.
     * 
     * @return The value of the DatabaseData for the type, if it is supposed to
     *         be evaluated in a manner that is case sensitive or not
     * 
     **/	
     ...
     * 
     * @return The value of the DatabaseData for the type, if it is supposed to
     *         be evaluated in a manner that is punctuation sensitive or not
     * 
     **/	
