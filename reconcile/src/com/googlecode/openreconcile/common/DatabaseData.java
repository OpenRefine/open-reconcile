...
public class DatabaseData implements Serializable{
     ...
     * wizard method, it populates only the fields necessary to find more
     * information.
     * 
     * @param mSource
     *            The name of the source type to be added to the configuration
     *            file.
     * @param mName
     *            The service name or the database name depending on the type to
     *            be added to the configuration file.
     * @param mPortnumber
     *            The port number to be added to the configuration file.
     * @param mServername
     *            The server name to be added to the configuration file.
     * @param mUser
     *            The username to be added to the configuration file.
     * @param mPass
     *            The password to be added to the configuration file.
     * 
     */
