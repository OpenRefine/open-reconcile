...
public class SynonymData implements Serializable {
     ...
     * 
     * @param from
     *            the string that is the string that should be replace
     * @param to
     *            the string the "from" string should be converted to
     * @param thisType
     *            the type this rule should be applied to
     */
    ...
    /**
     * Returns a list of column names. This is mostly a helper function for the
     * server.
     * 
    ...
    /**
     * Returns a list of values to be put into the database table. This is
     * mostly a helper function for the server.
     * 
